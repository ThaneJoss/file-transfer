        ...
        <div className="account-hero__header">
          <div className="flex min-w-0 items-center gap-4">
            ...
            <div className="min-w-0">
              ...
              <h1 className="mt-1.5 text-[28px] font-semibold tracking-[-0.04em] text-ink">账户与用量</h1>
            ...
            <Panel className="usage-service-card" key={row.id} testId={`usage-card-${row.id}`}>
              <div className="flex min-w-0 items-start justify-between gap-4">
                <div className="min-w-0">
                  ...
                  <h2 className="mt-2 text-xl font-semibold tracking-[-0.03em] text-ink">{row.label}</h2>
              ...
              <div className="mt-6">
                <div className="text-[clamp(28px,4vw,38px)] font-semibold leading-tight tracking-[-0.045em] text-ink">
                  {formatQuantity(summary.usage, summary.unit)}
                </div>
                <div className="mt-1 font-mono text-xs font-bold tracking-[0.08em] text-muted uppercase">
...
function UsageMetric({
  ...
  return (
    <div className="usage-metric">
      ...
      <div className="min-w-0">
        <div className="truncate text-xs font-semibold tracking-[0.08em] text-muted uppercase">{label}</div>
        <div className="mt-1 truncate text-xl font-semibold tracking-[-0.035em] text-ink" title={value}>{value}</div>
      </div>
    </div>
  );
}
