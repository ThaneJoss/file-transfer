    ...
    <Panel className="home-transfer-panel transfer-panel" testId="download-panel">
      <header className="transfer-panel__header">
        <div>
          ...
          <h2 className="mt-1.5 text-xl font-semibold tracking-[-0.03em] text-ink sm:text-2xl">下载文件</h2>
      ...
      {receiver.descriptor && (
        <div className="receiver-file" data-testid="receiver-file">
          ...
          <div className="min-w-0">
            <span className="block font-mono text-xs font-bold tracking-[0.14em] text-muted uppercase">
              Incoming file
            </span>
      ...
      {receiver.phase === "complete" && (
        <div className="download-complete" data-testid="download-complete">
          ...
          <div className="min-w-0">
            ...
            {receiver.winner && (
              <p className="mt-1 font-mono text-xs font-bold text-positive">
